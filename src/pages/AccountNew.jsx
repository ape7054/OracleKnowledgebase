...
const GlassmorphicPaper = styled(Paper)(({ theme }) => ({
  ...
  '&:hover': {
    ...
    boxShadow: theme.palette.mode === 'dark'
      ...
      : '0 12px 40px 0 rgba(145, 158, 171, 0.3)',
  }
}));
        ...
        <Grid item xs={12} sm={6} md={4} key={asset.symbol}>
          <Card sx={{ 
            ...
            boxShadow: theme.palette.mode === 'dark' 
              ...
              : '0 4px 20px 0 rgba(145, 158, 171, 0.2)',
            display: 'flex',
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <Typography variant="body1" sx={{ color: asset.color, fontWeight: 500 }}>
                {asset.change}
              </Typography>
            </Box>
          </Card>
  ...
  const fetchMarketData = async () => {
    try {
      ...
      if (response.success && response.data) {
        // Update static assets with API price data
            ...
            <GlassmorphicPaper>
              {loading ? (
                ...
                <>
                  ...
                  {isMobile ? (
                    <AssetsCardView assets={marketData} />
                  ) : (
                    <AssetsTableView assets={marketData} />
                  )}
                </>
              )}
            </GlassmorphicPaper>

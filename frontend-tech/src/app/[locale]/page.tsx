...
export async function generateMetadata({ params }: HomeProps): Promise<Metadata> {
  ...
  return {
    ...
    keywords: locale === 'zh' 
      ? ['Next.js', 'React', 'TypeScript', 'Go', 'Docker', '全栈开发', '微服务', 'WebSocket', '性能优化', '技术展示']
      : ['Next.js', 'React', 'TypeScript', 'Go', 'Docker', 'Full-Stack', 'Microservices', 'WebSocket', 'Performance', 'Tech Showcase'],
    openGraph: {
      type: 'website',
      ...
      >
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {/* 前端开发卡片 */}
            <Link 
              href={`/${locale}/knowledge?category=${siteConfig.knowledgeDomains.frontend}`}
            ...
            {/* 后端开发卡片 */}
            <Link 
              href={`/${locale}/knowledge?category=${siteConfig.knowledgeDomains.backend}`}
              className="block group"
            ...
            >
              <Card className="border border-border/50 bg-card/50 backdrop-blur hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 h-full group-hover:border-primary/50">
                <CardContent className="p-4 md:p-6 space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between">
                    <Server className="h-8 w-8 md:h-10 md:w-10 text-primary" />
                    <Badge variant="outline" className="text-xs">
            ...
            {/* DevOps卡片 */}
            <Link 
              href={`/${locale}/knowledge?category=${siteConfig.knowledgeDomains.devops}`}
              className="block group"
            ...
            >
              <Card className="border border-border/50 bg-card/50 backdrop-blur hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 h-full group-hover:border-primary/50">
                <CardContent className="p-4 md:p-6 space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between">
                    <Container className="h-8 w-8 md:h-10 md:w-10 text-primary" />
                    <Badge variant="outline" className="text-xs">
            ...
            {/* 架构设计卡片 */}
            <Link 
              href={`/${locale}/knowledge?category=${siteConfig.knowledgeDomains.architecture}`}
              className="block group"
            ...
            {/* 性能优化卡片 */}
            <Link 
              href={`/${locale}/knowledge?category=${siteConfig.knowledgeDomains.performance}`}
      ...
      >
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            {/* Next.js 文档 */}
            <Link 
              href={siteConfig.articles.featured.nextjs.slug || `/${locale}/knowledge?category=${siteConfig.articles.featured.nextjs.category}`}
              className="block group"
              ...
              <Card className="border border-border/50 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 h-full group-hover:border-primary/50">
                <CardContent className="p-4 md:p-6 space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <FileCode className="h-5 w-5 md:h-6 md:w-6 text-purple-500" />
                  </div>
            ...
            {/* Go 后端文档 */}
            <Link 
              href={siteConfig.articles.featured.go.slug || `/${locale}/knowledge?category=${siteConfig.articles.featured.go.category}`}
              className="block group"
              ...
              <Card className="border border-border/50 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 h-full group-hover:border-primary/50">
                <CardContent className="p-4 md:p-6 space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Terminal className="h-5 w-5 md:h-6 md:w-6 text-blue-500" />
                  </div>
                  <h3 className="text-base md:text-lg font-semibold group-hover:text-primary transition-colors">
            ...
            {/* Docker 部署文档 */}
            <Link 
              href={siteConfig.articles.featured.docker.slug || `/${locale}/knowledge?category=${siteConfig.articles.featured.docker.category}`}
              className="block group"
              ...
              <Card className="border border-border/50 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 h-full group-hover:border-primary/50">
                <CardContent className="p-4 md:p-6 space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Container className="h-5 w-5 md:h-6 md:w-6 text-green-500" />
                  </div>
                  <h3 className="text-base md:text-lg font-semibold group-hover:text-primary transition-colors">
          ...
          <div className="space-y-8 md:space-y-10 lg:space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 pt-4 md:pt-8">
              {[
                ...
                { icon: Container, color: 'text-green-500' }
              ].map((item, index) => {

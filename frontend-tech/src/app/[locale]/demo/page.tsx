...
export default function DemoPage() {
  ...
  const demoCards = [
    ...
    },
    {
      ...
      href: `/${locale}/demo/matrix-comparison`,
    },
    {
      id: 'responsive',
      icon: Smartphone,

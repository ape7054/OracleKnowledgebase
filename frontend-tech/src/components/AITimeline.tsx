...
import { aiProjects } from '@/config/ai-projects'
import { getProjectIcon } from '@/lib/ai-icons'
...
export function AITimeline({ updates, filterProjectId }: AITimelineProps) {
  ...
  const getProject = (projectId: string) => {
    return aiProjects.find(p => p.id === projectId)
  }
  ...
  return (
    <div className="space-y-4">
      {sortedUpdates.map((update, index) => {
        ...
        const ProjectIcon = project ? getProjectIcon(project.id) : null
